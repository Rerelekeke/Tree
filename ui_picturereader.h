...
public:
    ...
    {
        PictureReader->setWindowTitle(QApplication::translate("PictureReader", "Dialog", nullptr));
        labelPicture->setText(QString());
        pushButtonOk->setText(QApplication::translate("PictureReader", "Ok", nullptr));
        pushButtonCancel->setText(QApplication::translate("PictureReader", "Cancel", nullptr));
    } // retranslateUi
